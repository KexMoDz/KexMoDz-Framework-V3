-- [[ KexMoDz Framework V3.2.3 - Delta Execute Fix ]]
...
Title.Text = "KexMoDz Framework V1.9.9"
...
-- --- FPS BOOSTER (DELTA SAFE BLACKOUT) ---
local function ToggleFPSBooster(state)
    if state then
        ...
        -- Sicherer Blackout: Nur Deaktivieren, nicht löschen!
        for _, v in pairs(Lighting:GetChildren()) do
            if v:IsA("Sky") or v:IsA("Atmosphere") or v:IsA("Clouds") then
                v.Parent = nil -- Nur kurz entfernen statt Destroy
            end
        end
